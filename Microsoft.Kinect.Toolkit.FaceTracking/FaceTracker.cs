...
//            Console.WriteLine("HELLO WORLD 3");
            ...
            FaceTrackingRegisterDepthToColor newRegisterDepthToColorDelegate)
        {
            ...
            this.frame = this.CreateResult(out hr); //MIKE LOOK HERE
/*            System.Diagnostics.Debug.Write("X: "+this.frame.Rotation.X);
            System.Diagnostics.Debug.Write("Y: " + this.frame.Rotation.Y);
            System.Diagnostics.Debug.Write("Z: " + this.frame.Rotation.Z);*/
//            Console.WriteLine("HELLO WORLD 1");
        ...
        //Our Main Function*******************************************************************************************************************
        //FaceTrackFrame frame main methods: 
        //Rotation - Majority of our work, TrackSuccessful, Translation, Scale, FaceRect     In the FaceTrackFrame.cs file
        //
        //Easy Debug info - Debug.WriteLine(""); To bring up debug window  Ctrl-Alt-O
            ...
            Rect regionOfInterest)
        {
            ...
            //Useful for testing FaceTrackFrame numbers, every 30 frames is approximately  1/second
            if (this.totalSuccessTracks % 30 == 0)
            {
                frameNum++;

                //Write Frame# Rotation TimeStamp to file, change from local
                using (System.IO.StreamWriter file = new System.IO.StreamWriter(@"C:\Users\Anthony\Dropbox\Distracted-Driver-Detection-master\test.txt", true))
                {
                    file.WriteLine("Frame#: " + frameNum + "   Rotation: X = " + frame.Rotation.X + "  Y = " + frame.Rotation.Y + "  TimeStamp: " + DateTime.Now.TimeOfDay);
                }
            }
        ...
        //Sounds are local so change them to your own
